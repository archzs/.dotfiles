...
//Launch XIVLauncher from Steam
static const char *xivcmd[] = {"XIVLauncher.Core", NULL};
...
static const char *brightness_up[] = {"xbacklight", "-inc", "0.1", NULL};
static const char *brightness_down[] = {"xbacklight", "-dec", "0.1", NULL};
...
static Key keys[] = {
	...
	{ MODKEY|ControlMask,           XK_g,      spawn,          {.v = lutriscmd } },
        { MODKEY|ControlMask,           XK_f,      spawn,          {.v = xivcmd } },
